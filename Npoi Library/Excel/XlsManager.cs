...
namespace Npoi_Library.Excel.XlsManager
{
    ...
    public class XlsManager
    {
        ...
        private void InitializeDocument(ExcelOptions options)
        {
            ...
            if (options != null)
            {
                headerCellStyle = (HSSFCellStyle)GetHeaderStyle(options.HeaderStyle);
                bodyCellStyle = GetBodyStyle(options.BodyStyle);
            }
            else
            {
                headerCellStyle = (HSSFCellStyle)GetDefaultHeaderStyle();
        ...
        private void DrawFooter(string footer)
        {
            ...
            HSSFTextbox textbox1 = (HSSFTextbox)patriarch.CreateTextbox(new HSSFClientAnchor(0, 0, 0, 0, (short)0, txtStartIndex, (short)12, txtStartIndex + 5));
            textbox1.LineStyle = LineStyle.None;
            textbox1.MarginLeft = 5;
            textbox1.String = new HSSFRichTextString(footer);
            textbox1.String.ApplyFont(footerFont);
            // End: Textbox
        }
        ...
        private void WorkbookFinalProcessing()
        {
            ...
            // Ensures the vertical scroll is in the first page
        ...
        private ICellStyle GetDefaultHeaderStyle()
        {
            ...
            // Background color
            short index = (short)ColorIndex.HeaderBgColor;
            palette.SetColorAtIndex(index, 187, 255, 184);
        ...
        private ICellStyle GetEmptyStyle()
        {
            ...
            palette.SetColorAtIndex(index, 255, 255, 150);
